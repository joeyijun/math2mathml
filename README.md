...
| `image_max_edge` | 截图送入模型前的最长边像素，默认 `1600`，可降低延迟与费用 |
| `jpeg_quality` | 截图 JPEG 压缩质量，默认 `90` |
| `request_timeout` | API 请求超时时间（秒），默认 `45` |
| `request_retries` | 临时网络错误、429、5xx 的重试次数，默认 `2` |
